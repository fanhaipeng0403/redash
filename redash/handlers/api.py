...
from redash.handlers.alerts import AlertResource, AlertListResource, AlertSubscriptionListResource, \
    AlertSubscriptionResource
from redash.handlers.base import org_scoped_rule
from redash.handlers.dashboards import DashboardListResource, DashboardResource, DashboardShareResource, \
    PublicDashboardResource
from redash.handlers.dashboards import DashboardTagsResource
from redash.handlers.data_sources import DataSourceTypeListResource, DataSourceListResource, DataSourceSchemaResource, \
    DataSourceResource, DataSourcePauseResource, DataSourceTestResource
...
from redash.handlers.favorites import QueryFavoriteListResource, QueryFavoriteResource, DashboardFavoriteListResource, \
...
from redash.handlers.queries import QueryForkResource, QueryRefreshResource, QueryListResource, QueryRecentResource, \
    QuerySearchResource, QueryResource, MyQueriesResource
...
#######################################################################
# 类的命名
# xxxx  +修饰语(在url中）+ List(包含s)+  Resource
...
# alert订阅
api.add_org_resource(AlertSubscriptionListResource, '/api/alerts/<alert_id>/subscriptions',
                     endpoint='alert_subscriptions')
api.add_org_resource(AlertSubscriptionResource, '/api/alerts/<alert_id>/subscriptions/<subscriber_id>',
...
api.add_org_resource(GroupDataSourceResource, '/api/groups/<group_id>/data_sources/<data_source_id>',
...
api.add_org_resource(CheckPermissionResource, '/api/<object_type>/<object_id>/acl/<access_type>',
